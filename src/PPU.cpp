...
PPU::PPU() {
    ...
    // Authentic Nestopia YUV Hex Array (0xAARRGGBB directly mapped to Vulkan B8G8R8A8 unorm)
    ...
    palScreen[0x30] = 0xFFF8F8F8; palScreen[0x31] = 0xFFA4E4FC; palScreen[0x32] = 0xFFB8B8F8; palScreen[0x33] = 0xFFD8B8F8;
